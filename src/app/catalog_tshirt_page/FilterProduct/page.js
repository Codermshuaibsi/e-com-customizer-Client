...
export default function ProductPageTshirt() {
  const hats = [
        {
  ...
  const colors = ["Blue", "Black", "Red", "Green", "Wine"];
              ...
              {filteredHats.map((hat, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between px-4 pb-4">
                    <button className="flex-1 bg-[#3559C7] text-white font-bold text-sm py-3 px-4 flex items-center justify-center gap-2 hover:bg-blue-800 transition">
                      <LiaShoppingBagSolid />
                      SHOP NOW
                    </button>
